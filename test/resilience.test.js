...
// (fake) MIS server, so this proves the whole /live path, not just the
// client library in isolation.
test('GET /live degrades gracefully (200) when MIS returns garbage instead of JSON', async () => {
