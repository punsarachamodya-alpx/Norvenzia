...
const sections = [
...

  {
    ...
    fields: [
      ...
      { path: 'contactEmail', label: 'Contact email (form + contact page)', type: 'text' },
      { path: 'footerEmail', label: 'Footer email', type: 'text' },
      { path: 'phone', label: 'Phone (footer)', type: 'text' },
      { path: 'registrationLine', label: 'Registration line (footer)', type: 'text' },
      { path: 'hub', label: 'Hub location', type: 'text' },
...

  {
    ...
    fields: [
      ...
      // The divisions shown in this section are edited on the Services
      // page (see 'what-we-do' -> divisions below); this section only owns
      // its own intro copy.
...

  {
    key: 'what-we-do',
    label: 'Services',
    blurb: 'The five divisions and engagement tiers. Public URL: /services.',
    fields: [
      ...metaFields,
      ...heroFields,
      {
...

  {
    key: 'how-we-work',
    label: 'The Model',
    blurb: 'The two-location model, methodology, and security posture. Public URL: /the-model.',
    fields: [
      ...metaFields,
      ...heroFields,
...

  {
    key: 'who-we-are',
    label: 'About Us',
    blurb: 'Founder story, team, and mission. Public URL: /about-us.',
    fields: [
      ...metaFields,
      ...heroFields,
      ...
      // The divisions listed in this table are edited on the Services
      // page (see 'what-we-do' -> divisions above); this section only owns
      // its own intro copy.
      ...closingFields
    ]
  },
